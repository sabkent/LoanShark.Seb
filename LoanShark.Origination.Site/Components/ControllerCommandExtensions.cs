...
namespace LoanShark.Origination.Site.Components
{
    ...
    {
        public static CommandActionResult<TModel, TCommand> ExecuteCommand<TModel, TCommand>(this Controller controller, TModel model) where TCommand :class, ICommand
        {
